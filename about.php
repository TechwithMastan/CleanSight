    ...
    <div class="container">
      <div class="about-content">
        <div class="left-content">
          ...
          <p>
            I am 20 year old, CSE student studying at VELTECH University.
            I really enjoy solving problems as well as making new webpages. I can't stop learning new
  ...
  <section id="my-works">
    <div class="portfolio">
      ...
      <div class="portfolio-content container">
        <div class="proj-1">
          <img src="https://i.postimg.cc/KYLJtvBP/p3.png">
          <div class="proj1-details">
            <i class="fab fa-html5"></i>
            <i class="fab fa-css3-alt"></i>
            <i class="fab fa-js"></i>
            <h2>CleanSight Website</h2>
            <p>Build Using HTML,CSS,JS,PHP,MYSQL</p>
            <button><a href="https://github.com/TechwithMastan/cleansight" target="blank">View source <i
                  class="fas fa-external-link-alt"></i></a>
            </button>
            <button><a href="https://cleansight.infinityfreeapp.com/index.php" target="blank">Try it Live <i
                  class="fas fa-external-link-alt"></i></a>
            </button>
          </div>
        </div>
        ...
        <div class="proj-2">
          <img src="https://i.postimg.cc/kXWpc5QX/profile2.png">
          <div class="proj2-details">
            <i class="fab fa-html5"></i>
            <i class="fab fa-css3-alt"></i>
            <h2>Profile Card</h2>
            <p>Build Using HTML,CSS</p>
            <button><a href="https://github.com/TechwithMastan/profile.git" target="blank">View source <i
                  class="fas fa-external-link-alt"></i></a>
            </button>
            <button><a href="https://codepen.io/TechwithMastan/pen/GReRWEP" target="blank">Try it Live <i
                  class="fas fa-external-link-alt"></i></a>
            </button>
          </div>
  ...
  <div class="contact" id="contact-me">
    <div class="container">
      <div class="contact-content">
        ...
        <a href="https://github.com/TechwithMastan" target="blank"><i class="fab fa-github"></i> Github</a>
