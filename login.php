      ...
      <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-4 form-wrapper bg-light rounded-lg shadow-lg py-4 px-5">
        ...
        <form method="post" action="">
          ...
          <div class="form-group">
            <label for="username" class="font-weight-bold">Office ID:</label>
            <input type="text" class="form-control form-control-lg" id="username" name="user_name"
              placeholder="Enter Your Office ID" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group mt-4">
            <button type="submit" name="login_user" class="btn btn-primary btn-block btn-lg"
              value="Login">Login</button>
          </div>
        </form>
        <p class="text-center mt-2 mb-0">Don't have an account? <a href="register.php" class="register-link">Register
            here</a></p>
      </div>
    </div>
  </div>
