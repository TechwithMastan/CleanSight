        ...
        <form method="post" action="" id="register_form">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg" id="username" name="user_name"
              placeholder="Enter your OfficeID" required>
          </div>
          <div class="form-group">
            <label for="zipcode">
          ...
          <div class="form-group mt-4">
            ...
            <button type="submit" name="reg_user" id="reg-btn"
              class="btn btn-primary btn-block btn-lg">Register</button>
          </div>
        </form>
        <p class="text-center mt-2 mb-0">Already have an account? <a href="login.php" class="login-link">Login here</a>
        </p>
      </div>
    </div>
  </div>
